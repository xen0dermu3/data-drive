...
export function ShoppingCartGetItemServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      ...
      GrpcMethod('ShoppingCartGetItemService', method)(
    ...
    for (const method of grpcStreamMethods) {
      ...
      GrpcStreamMethod('ShoppingCartGetItemService', method)(
        constructor.prototype[method],
        method,
        descriptor,
      );
...
export function ShoppingCartAddItemServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      ...
      GrpcMethod('ShoppingCartAddItemService', method)(
        constructor.prototype[method],
        method,
        descriptor,
      );
    ...
    for (const method of grpcStreamMethods) {
      ...
      GrpcStreamMethod('ShoppingCartAddItemService', method)(
        constructor.prototype[method],
        method,
        descriptor,
      );
